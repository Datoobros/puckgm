...
export function TeamManagementCard({
  ...
  return (
    <Card className="space-y-5">
      {teams.map((team) => (
        <div key={team.id} className="space-y-3 border-b border-border pb-4 last:border-0 last:pb-0">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <form action={setTeamDivisionAction.bind(null, leagueId, team.id)} className="flex items-center gap-1">
              ...
              <Button type="submit" size="sm">Set division</Button>
            </form>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <form action={regenerateTeamClaimCodeAction.bind(null, leagueId, team.id)}>
              <Button type="submit" size="sm">{team.claimCode ? "Regenerate claim link" : "Generate claim link"}</Button>
            </form>
          </div>
