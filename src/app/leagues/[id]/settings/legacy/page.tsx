...
// Everything from the old single-page Commissioner Settings that hasn't been
// moved into its own LM Tools sub-page yet (plans/lm-tools-batch.md Task 1
// note 9) — Task 2 splits this into settings/league, /scoring,
// /roster-settings, /schedule-settings, /draft-settings and deletes this
// file. Kept verbatim (same form, same action) so the app stays fully
// functional between the two commits.
export default async function LegacySettingsPage(props: PageProps<"/leagues/[id]/settings/legacy">) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <h1 className="mt-1 text-2xl font-semibold tracking-tight">Legacy settings page</h1>
      <p className="mt-2 text-xs text-muted">
        Temporary — everything below moves into its own LM Tool in a follow-up pass.
      </p>
